        ...
        <div className="container login center-align">
          ...
          <div className="row">
            ...
            <div className="col s12 m4">
              <span className="glyphicons glyphicons-facetime-video splash-icons"></span>
            ...
            <div className="col s6 m4">
              <span className="glyphicons glyphicons-calendar splash-icons"></span>
            ...
            <div className="col s6 m4">
              <span className="glyphicons glyphicons-envelope splash-icons"></span>
