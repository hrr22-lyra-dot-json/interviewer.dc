...
var User = db.define('Project', {
  id: {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
  name: Sequelize.STRING,
  email: Sequelize.STRING
});

var UserMeeting = db.define('Project', {
  id: {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
  user_id: Sequelize.INTEGER,
  meeting_id: Sequelize.INTEGER
});

UserMeeting.belongsTo(Meeting, {foreignKey: 'project_id'});
UserMeeting.belongsTo(User, {foreignKey: 'project_id'});
